import { clone } from "./dynamicPrototype"

describe('dynamicPrototype', () => {
    describe('clone', () => {
        describe('first name', () => {
            ...
            test('first name is set on instance and not on prototype', () => {
                // Arrange
                const sut = new clone()
                // Act
                // Assert
                expect(sut.hasOwnProperty('firstName')).toBeTruthy()
           })
        })
        ...
        describe('last name', () => {
            ...
            test('last name is set on instance and not on prototype', () => {
                // Arrange
                const sut = new clone()
                // Act
                // Assert
                expect(sut.hasOwnProperty('lastName')).toBeTruthy()
           })
        })
        ...
        describe('gender', () => {
            ...
            test('gender is set on instance and not on prototype', () => {
                // Arrange
                const sut = new clone()
                // Act
                // Assert
                expect(sut.hasOwnProperty('gender')).toBeTruthy()
           })
        })
        ...
        describe('hair color', () => {
            ...
            test('hair color is set on instance and not on prototype', () => {
                // Arrange
                const sut = new clone()
                // Act
                // Assert
                expect(sut.hasOwnProperty('hairColor')).toBeTruthy()
           })
        })
